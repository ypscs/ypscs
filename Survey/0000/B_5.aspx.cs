...
public partial class Survey_0000_B_5 : System.Web.UI.Page
{
    string[] ddlitem = new string[] { "230", "232", "234" };
    string[] txtitem = new string[] { "236", "243", "244", "245", "246", "247", "248", "249", "251", "252" };
    string[] rdoitem = new string[] { "231", "233", "235", "237", "238", "239", "240", "241", "242", "250", "253" };
    ...
    private void LoadData()
    {
        if (Session["svid"] != null)
        {
            ...
            if (sv.Load(Session["svid"].ToString(), ""))
            {
                ...
                DataRow[] drs = sv.SurveyData.Select("seq>='230' AND seq<='253'");
