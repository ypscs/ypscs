...
public partial class Survey_0000_B_3b : System.Web.UI.Page
{
    string[] ddlitem = new string[] { "139", "141", "143", "145", "147", "149", "151", "153", "155", "157", "159", "161", "163" };
    string[] txtitem = new string[] { "165", "169", "170", "171", "172", "173", "174", "176", "177" };
    string[] rdoitem = new string[] { "140", "142", "144", "146", "148", "150", "152", "154", "156", "158", "160", "162", "164", "166", "167", "168", "175", "178" };
    string[] chkitem = new string[] { "138" };
    ...
    private void LoadData()
    {
        if (Session["svid"] != null)
        {
            ...
            if (sv.Load(Session["svid"].ToString(), ""))
            {
                ...
                DataRow[] drs = sv.SurveyData.Select("seq>='138' AND seq<='178'");
