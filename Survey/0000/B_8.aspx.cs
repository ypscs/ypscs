...
public partial class Survey_0000_B_8 : System.Web.UI.Page
{
    string[] ddlitem = new string[] { "321", "323", "325" };
    string[] txtitem = new string[] { "327", "331", "332", "333", "334", "335", "336", "338", "339" };
    string[] rdoitem = new string[] { "320", "322", "324", "326", "328", "329", "330", "337", "340" };
    ...
    private void LoadData()
    {
        if (Session["svid"] != null)
        {
            ...
            if (sv.Load(Session["svid"].ToString(), ""))
            {
                ...
                DataRow[] drs = sv.SurveyData.Select("seq>='320' AND seq<='340'");
