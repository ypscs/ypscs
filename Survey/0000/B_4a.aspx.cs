...
public partial class Survey_0000_B_4a : System.Web.UI.Page
{
    string[] ddlitem = new string[] { "179", "181", "183", "185" };
    string[] txtitem = new string[] { "187", "191", "192", "193", "194", "195", "196", "198", "199" };
    string[] rdoitem = new string[] { "180", "182", "184", "186", "188", "189", "190", "197", "200" };
    ...
    private void LoadData()
    {
        if (Session["svid"] != null)
        {
            ...
            if (sv.Load(Session["svid"].ToString(), ""))
            {
                ...
                DataRow[] drs = sv.SurveyData.Select("seq>='179' AND seq<='200'");
