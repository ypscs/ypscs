...
public partial class Survey_0000_B_4b : System.Web.UI.Page
{
    string[] ddlitem = new string[] { "204", "206", "208", "210", "212", "214" };
    string[] txtitem = new string[] { "216", "220", "221", "222", "223", "224", "225", "227", "228" };
    string[] rdoitem = new string[] { "205", "207", "209", "211", "213", "215", "217", "218", "219", "226", "229" };
    string[] chkitem = new string[] { "201", "202", "203" };
    ...
    private void LoadData()
    {
        if (Session["svid"] != null)
        {
            ...
            if (sv.Load(Session["svid"].ToString(), ""))
            {
                ...
                DataRow[] drs = sv.SurveyData.Select("seq>='201' AND seq<='229'");
