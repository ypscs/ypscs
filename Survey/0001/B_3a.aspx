<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="B_3a.aspx.cs" Inherits="Survey_0001_B_3a" StylesheetTheme="Base" %>
                ...
                <table>
                    ...
                    <tr>
                        <td><span class="SurveyQuesLargeBold">
                            <asp:CheckBox ID="Q97" runat="server" />If you do not purchase YIEH PHUI’s galvanized steel coils , please skip item 3a.1-3a.11</span> </td>
                    </tr>
                    <tr>
                                ...
                                <blockquote>
                                   <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion"><span class="SurveyUnderline">Others. Please specify:</span><asp:TextBox ID="Q124" runat="server"></asp:TextBox></td>
                                            <td></td>
                                            ...
                                            <td colspan="11">
                                                <table  class="SurveyQuestion">
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align: top;">No.:<asp:TextBox ID="Q128" runat="server" style="width: 30px;"></asp:TextBox></td>
                                                        <td style="vertical-align: top;">For example:</td>
                                                        <td>
                                                            <asp:TextBox ID="Q129" runat="server" Width="300px" Rows="2" TextMode="MultiLine"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td style="vertical-align: top;">No.:<asp:TextBox ID="Q130" runat="server" style="width: 30px;"></asp:TextBox></td>
                                                        <td style="vertical-align: top;">For example:</td>
                                                        <td>
                                                            <asp:TextBox ID="Q131" runat="server" Width="300px" Rows="2" TextMode="MultiLine"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="SurveyQuestion">
                                                            <asp:RadioButton ID="Q134_1" GroupName="Q134" onclick="radiocheck(this);" runat="server" />Often happens (3 more times /year)<br /><asp:RadioButton ID="Q134_2" GroupName="Q134" onclick="radiocheck(this);" runat="server" />Sometimes happens(1-2 times /year)</td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td class="SurveyQuestion">
                                                            <asp:RadioButton ID="Q137_1" GroupName="Q137" onclick="radiocheck(this);" runat="server" />Often happens (3 more times /year)<br /><asp:RadioButton ID="Q137_2" GroupName="Q137" onclick="radiocheck(this);" runat="server" />Sometimes happens(1-2 times /year)</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
